    ...
    <header className="px-5 bg-[#012A4A] shadow-md z-50">
      <nav className="flex items-center justify-between py-4 text-white">
        ...
        <div className="hidden md:flex items-center gap-5 text-lg">
          ...
          <Link href="/category" className="hover:text-gray-300 transition">
            Category
          </Link>
          <Link href="/testimony" className="hover:text-gray-300 transition">
            Testimony
          </Link>
        </div>
      ...
      {/* Mobile Nav */}
      {isMenuOpen && (
        <div className="flex flex-col md:hidden bg-white text-black px-5 py-3 gap-4 text-lg shadow-md z-40">
          ...
          <Link href="/testimony" onClick={closeMenu}>
            Testimony
          </Link>
        </div>
      )}
